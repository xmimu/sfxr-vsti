...
- **GENERATOR 列**（左）：7 个预设类别（PICKUP/COIN、LASER/SHOOT、EXPLOSION、POWERUP、HIT/HURT、JUMP、BLIP/SELECT）+ MUTATE / RANDOMIZE / PLAY SOUND / LOAD CONFIG / SAVE CONFIG；Standalone 额外提供 EXPORT AUDIO（WAV/OGG 导出、采样率与编码质量选择）
